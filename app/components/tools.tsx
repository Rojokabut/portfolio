...
export default function Tools() {
  return (
    <div id="deux-elements" className="w-full mt-5 grid md:grid-cols-2 grid-cols-1 xl:gap-5 lg:gap-2 gap-4 overflow-hidden">
      {/* Database card */}
      <div className="animate__animated animate__bounceInLeft px-4 py-3 rounded-2xl bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white shadow-lg space-y-5">
        <div className="flex items-center space-x-4">
          <div className="bg-gradient-to-tr from-gray-200 to-white p-3 rounded-xl">
            <Image alt="backend" src={bdd} width={35} height={35} />
          </div>
